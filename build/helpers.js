...
exports.resizeImg = exports.THUMB_IMG_PATH = exports.FULL_IMG_PATH = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(path_1.default.join(exports.FULL_IMG_PATH, "".concat(imgName, ".").concat(ext)))
                            .resize(imgWidth, imgHeight)
                            .toFile(path_1.default.join(exports.THUMB_IMG_PATH, "".concat(imgName, "_").concat(imgWidth, "_").concat(imgHeight, ".").concat(ext)))];
                case 2:
                    //resizes the image from the full file and outputs it to the thumb file
                    _a.sent();
                    return [3 /*break*/, 4];

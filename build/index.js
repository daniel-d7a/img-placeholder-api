...
exports.app.get("/images", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var imgName, imgWidth, imgHeight, images, fullName, thumbs, thumbName, ext, err_1, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.trys.push([4, 6, , 7]);
                return [4 /*yield*/, (0, helpers_1.resizeImg)(imgName, parseInt(imgWidth), parseInt(imgHeight), ext)];
            case 5:
                _a.sent();
                return [3 /*break*/, 7];
            case 6:
            ...
            case 7:
                //return the thumb
                res.status(200).sendFile(path_1.default.join(helpers_1.THUMB_IMG_PATH, "".concat(imgName, "_").concat(imgWidth, "_").concat(imgHeight, ".").concat(ext)));
                return [3 /*break*/, 9];
            case 8:
                //tell the user
